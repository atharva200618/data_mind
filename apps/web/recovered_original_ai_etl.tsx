...
export default function AIETLPage() {
  ...
  const [activeMode, setActiveMode] = useState<"one-click" | "conversational">("one-click");
              ...
              {activeMode === "one-click" ? (
                        ...
                        <div className="flex items-start gap-4">
                          ...
                          <div>
                            <div className="flex items-center gap-2">
                              <h4 className="text-sm font-bold font-space text-white group-hover:text-cyan-400 transition-colors">
                                {preset.name}
                              </h4>
                              {preset.badge && (
                                <span className="text-[8px] font-black font-space px-2 py-0.5 rounded-full bg-cyan-400/20 text-cyan-400 border border-cyan-400/30 uppercase tracking-wider">
                                  {preset.badge}
                                </span>
                              )}
                            </div>
                ...
                <div className="glass p-8 rounded-[2.5rem] space-y-6">
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mb-4">Provide detailed instructions on how the AI model should clean, modify, or engineer features.</p>
                    <textarea
                      value={instruction}
