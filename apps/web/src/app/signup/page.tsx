...
import { Sparkles, Mail, Lock, ShieldCheck, ArrowRight, Loader2, AlertCircle } from "lucide-react";
    ...
    <main className="relative min-h-screen flex items-center justify-center overflow-hidden px-4 py-16">
      ...
      <div className="z-10 w-full max-w-md">
        ...
        <div className="flex flex-col items-center mb-8 text-center">
          ...
          <h1 className="text-2xl font-bold tracking-tight font-space text-white mb-2">Create your account</h1>
          <p className="text-sm text-gray-400">Join the next-generation async ML pipeline platform</p>
        </div>
